...
public class FavoriteController {
    ...
    public Map<String, Object> findFavoriteList(@RequestParam(value = "userId") Integer userId,
        ...
        try {
            List<FavoriteVo> dataList = null;

            dataList = iFavoriteService.getAllFavorites(userId, type, subjectId, page, pageLine,tagId);
